...
export const menuBg: { key: string; label: string; note?: string; dishes: Dish[] }[] = [
  {
    key: "mqstoto",
    label: "Мястото",
    note: "Ресторант „Диана 1“ не публикува меню. Показано е само това, което сами съобщават.",
    dishes: [
      {
        n: "Ресторант",
        d: "ул. „Княз Ал. Дондуков-Корсаков“ 2",
      },
      {
...
export const menuEn: { key: string; label: string; note?: string; dishes: Dish[] }[] = [
  {
    key: "mqstoto",
    label: "The place",
    note: "Restaurant Diana 1 publishes no menu. Only what they state themselves appears here.",
    dishes: [
      {
        n: "A restaurant",
        d: "2 Knyaz Al. Dondukov-Korsakov St",
      },
      {
...
export const performerBg = "Ресторантът е на ул. „Княз Ал. Дондуков-Корсаков“ 2, в центъра на Пловдив.";

export const performerEn = "The restaurant is at 2 Knyaz Al. Dondukov-Korsakov Street, in the centre of Plovdiv.";
...
export const extraStrings = {
  bg: {
    ...
    menuTitle: "Мястото",
    menuLead: "Ресторант „Диана 1“ не публикува меню. Ето какво съобщават за самото място:",
    ...
    galleryLead: "Ресторант „Диана 1“ няма публикувани собствени фотографии на обекта.",
  ...
  en: {
    ...
    menuTitle: "The place",
    menuLead: "Restaurant Diana 1 publishes no menu. Here is what they state about the place itself:",
    ...
    galleryLead: "Restaurant Diana 1 has no published photographs of the venue.",
