...
export const site = {
  canonicalUrl: "https://mitev22.github.io/webbuild-plovdiv-wedding-venues/sites/diana-1",
...
export const palette = {
  note: "Ресторант „Диана 1“: no brand materials published — template palette kept as documented.",
} as const;
...
export const factsDict = {
  bg: {
    ...
    packagesNote: "Ресторант „Диана 1“ не публикува куверт. Опишете деня си във формата и ще получите лична оферта.",
  },
  en: {
    capacityRows: [
      {
    ...
    packagesNote: "Restaurant Diana 1 publishes no per-head price. Describe your day in the form for a personal offer.",
  },
} as const;
...
export const copyDict = {
  bg: {
    ...
    heroUnder: "Ресторант на ул. „Княз Ал. Дондуков-Корсаков“ 2.",
  ...
  en: {
    ...
    heroUnder: "A restaurant at 2 Knyaz Al. Dondukov-Korsakov Street.",
